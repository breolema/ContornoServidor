...
INSERT INTO `productos` (`CodProd`, `Nombre`, `Descripcion`, `Precio`, `Stock`, `CodCat`, `CodEstado`, `RutaImagen`) VALUES
	(1, 'Solomillo', 'Solomillo de cerdo 1kg', 4, 100, 1, 1, 'imagenes/productos/solomillo.jpg'),
	(2, 'Chorizo', '200g de chorizo', 2.5, 100, 2, 1, 'imagenes/productos/chorizo.jpg'),
	(3, 'Salmon', 'Lomo de salmon', 7.95, 100, 3, 1, 'imagenes/productos/salmon.jpg'),
...
INSERT INTO `usuarios` (`CodUsu`, `Usuario`, `Nombre`, `Correo`, `Clave`, `Pais`, `CP`, `Ciudad`, `Direccion`, `Rol`, `Activo`) VALUES
	(1, 'Admin', 'Admin', 'admin@gmail.com', 'e8dc8ccd5e5f9e3a54f07350ce8a2d3d', 'España', 15270, 'Cee', 'Cee', 1, 1),
	(2, 'Cliente', 'Cliente','breolema13@gmail.com', 'e8dc8ccd5e5f9e3a54f07350ce8a2d3d', 'España', 15270, 'Cee', 'Rua da Escola', 2, 1);
